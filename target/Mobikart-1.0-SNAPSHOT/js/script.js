...
function updateCart() {
    ...
    if (cart == null || cart.length == 0)
    {
        ...
        //using backtake (``) is nothing but multi-line String
        let table = `
        ...
        cart.map((item) => {
            ...
            table += `
              <tr>
                ...
                <td> <button onclick='deleteItemFromCart( ${item.pId} )' class='btn btn-danger btn-sm'> Delete </button> </td>
